...
CREATE INDEX ng3_addr_to_bdgu_fk2x ON ng3_address_to_building_unit USING btree (building_unit_id ASC NULLS LAST) WITH (FILLFACTOR = 90);
...
-- -------------------------------------------------------------------- 
-- ng3_occupants_to_space 
-- -------------------------------------------------------------------- 
CREATE TABLE ng3_occupants_to_space (
    occupants_id BIGINT NOT NULL,
    space_id     BIGINT NOT NULL,
    PRIMARY KEY (occupants_id, space_id)
);
CREATE INDEX ng3_occ_to_spc_fk1x ON ng3_occupants_to_space USING btree (occupants_id ASC NULLS LAST) WITH (FILLFACTOR = 90);
CREATE INDEX ng3_occ_to_spc_fk2x ON ng3_occupants_to_space USING btree (space_id ASC NULLS LAST) WITH (FILLFACTOR = 90);
...
CREATE INDEX ng3_oth_dev_tra_fkx  ON ng3_other_device USING btree (transmittance_id ASC NULLS LAST) WITH (FILLFACTOR = 90);
...
CREATE INDEX ng3_spc_spc_fk1x   ON ng3_space USING btree (space_parent_id ASC NULLS LAST) WITH (FILLFACTOR = 90);
CREATE INDEX ng3_spc_type_fkx   ON ng3_space USING btree (type ASC NULLS LAST) WITH (FILLFACTOR = 90);
CREATE INDEX ng3_spc_occ_fkx    ON ng3_space USING btree (occupants_id ASC NULLS LAST) WITH (FILLFACTOR = 90);
...
CREATE INDEX ng3_spc_spc_fk2x   ON ng3_space USING btree (space_id ASC NULLS LAST) WITH (FILLFACTOR = 90);
CREATE INDEX ng3_spc_bdg_fkx    ON ng3_space USING btree (building_id ASC NULLS LAST) WITH (FILLFACTOR = 90);
CREATE INDEX ng3_spc_msurf_fkx  ON ng3_space USING btree (lod0_multi_surface_id ASC NULLS LAST) WITH (FILLFACTOR = 90);
...
ALTER TABLE ng3_address_to_building_unit ADD CONSTRAINT ng3_addr_to_bdgu_fk2 FOREIGN KEY (building_unit_id) REFERENCES ng3_space (id) ON DELETE CASCADE;
...
ALTER TABLE ng3_layer ADD CONSTRAINT ng3_lyr_ng3_mat_fk FOREIGN KEY (material_id) REFERENCES ng3_material (id) ON DELETE SET NULL;
...
-- ng3_occupants_to_space
-- -------------------------------------------------------------------- 
ALTER TABLE ng3_occupants_to_space ADD CONSTRAINT ng3_occ_to_spc_fk1 FOREIGN KEY (occupants_id) REFERENCES ng3_occupants (id) ON DELETE CASCADE;
ALTER TABLE ng3_occupants_to_space ADD CONSTRAINT ng3_occ_to_spc_fk2 FOREIGN KEY (space_id) REFERENCES ng3_space (id) ON DELETE CASCADE;
...
ALTER TABLE ng3_other_device ADD CONSTRAINT ng3_oth_dev_opt_fk FOREIGN KEY (transmittance_id) REFERENCES ng3_optical_property (id) ON DELETE SET NULL;
...
ALTER TABLE ng3_space ADD CONSTRAINT ng3_spc_ng3_spc_fk1 FOREIGN KEY (space_parent_id) REFERENCES ng3_space (id);
ALTER TABLE ng3_space ADD CONSTRAINT ng3_spc_ng3_spc_fk2 FOREIGN KEY (space_id) REFERENCES ng3_space (id) ON DELETE SET NULL;
ALTER TABLE ng3_space ADD CONSTRAINT ng3_spc_ng3_occ_fk FOREIGN KEY (occupants_id) REFERENCES ng3_occupants (id) ON DELETE SET NULL;
...
-- ng3_zone_opening
-- -------------------------------------------------------------------- 
ALTER TABLE ng3_zone_opening ADD CONSTRAINT ng3_zn_opn_fk FOREIGN KEY (id) REFERENCES opening (id);
...
-- ng3_zone_thematic_surface 
-- -------------------------------------------------------------------- 
ALTER TABLE ng3_zone_thematic_surface ADD CONSTRAINT ng3_zn_thm_surf_fk FOREIGN KEY (id) REFERENCES thematic_surface (id);
