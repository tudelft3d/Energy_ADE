...
All thematic surfaces, all thermal boundaries, all thermal
openings are connected through XLinks to 
(Reverse)LayeredConstruction objects that are contained
in the LayeredConstructionLibrary.
Materials are contained in the the MaterialLibrary.

X3DMaterial objects for the thermal zone, the thermal
boundaries and thermal openings are available in the
global appearance.
